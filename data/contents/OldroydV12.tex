...
对于存在熵函数的双曲平衡律方程组，Yong发展了平衡态附近的整体存在性理论\cite{yong2004entropy,hanouzet2003global}。其整体存在性的证明是基于熵函数的存在性、Yong的稳定性条件和Kawashima理论。熵函数的存在性和稳定性条件已经验证。%对于Kawashima条件，对于非守恒形式含有熵的方程\eqref{eq:ECDFsecond1D}的整体存在性，无法采用一般的Kawashima理论直接得到。
