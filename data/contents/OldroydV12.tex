...
当$\kappa$足够小时，我们可以认为粘弹性的效应足够小，这时我们有理由相信仅考虑粘性效应足以对粘弹性流体做很好的近似描述。在本小节中，我们将说明一维的等温可压上对流Maxwell模型\eqref{eq:ECDFsecond1D}与经典的可压Navier-Stokes方程在$\kappa$很小时是一致的，即$\kappa$很小时Navier-Stokes方程可以很好地近似等温可压上对流Maxwell模型。
